  ...
  try {
    ...
    while(ist) {
        if(std::getline(ist, s)) {
            ...
            std::getline(iss, field, ',') ; month = stoi(field); // if(verbose) std::cout << field << ' ' << month << std::endl;
            std::getline(iss, field, ',') ; day   = stoi(field); // if(verbose) std::cout << field << ' ' << day << std::endl;
            std::getline(iss, field, ',') ; year  = stoi(field); // if(verbose) std::cout << field << ' ' << year << std::endl;
            std::getline(iss, field, '\n') ; temp  = stod(field); // if(verbose) std::cout << field << ' ' << temp << std::endl;
            // verbose = (year == 2001 && month == 1 && day < 9);
