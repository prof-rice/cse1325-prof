 ...
 *
 *  This version of StdDraw is a proper superset of and should be fully
 *  backward compatible with the original version accessed 2025.05.19 from
 *  https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java
 *  for use at the University of Texas at Arlington.
 *
 *  According to https://introcs.cs.princeton.edu/java/stdlib/, the original
 *  is copyright 2000-2005 by Robert Sedgewick and Kevin Wayne and is
 *  licensed under the GNU General Public License, version 3 (GPLv3).
 *  All changes to this file are copyright 2025 George F. Rice under
 *  the same license.
 *
 *  Todo
 *  ----
 ...
 *  <p>
 *  <b>Canvas size.</b>
 *  By default, all drawing takes places in a 1000-by-1000 canvas.
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * The shade of orange used in the University of Texas at Arlington's
     * identity. The RGB values are approximately (245, 128, 37).
     */
    public static final Color UTA_ORANGE = new Color(245, 128, 37);

    /**
     * The shade of blue is used in the University of Texas at Arlington's
     * identity. The RGB values are approximately (0, 100, 177).
     */
    public static final Color UTA_BLUE = new Color(0, 100, 177);

    /**
     * The 12-element color wheel array for creating pleasingly
     * multi-colored repetitive shapes.
     */
    public static final Color[] COLORWHEEL = new Color[] {
    ...
    /**
     * Sets the canvas (drawing area) to be 1000-by-1000 pixels.
    ...
    /**
     * Closes the standard drawing window (from AutoCloseable).
    ...
    ***************************************************************************/
    ...
    /**
     * Sets the pen color to the next color on the 12-element color wheel.
     *
     * StdDraw retains the last color assigned from the color wheel.
     * The current color does not affect the next pen color selected.
     */
    public static void nextPenColor() {
        setPenColor(COLORWHEEL[nextColor++ % COLORWHEEL.length]);
    }
...
*/
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        StdDraw.setPenColor(StdDraw.UTA_ORANGE);
        StdDraw.setPenRadius(0.02);
        StdDraw.arc(0.8, 0.2, 0.1, 200, 45);
        StdDraw.setPenColor(StdDraw.UTA_BLUE);
        StdDraw.point(0.8, 0.2);
