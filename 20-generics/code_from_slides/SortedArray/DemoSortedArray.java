public class DemoSortedArray {
    public static void main(String[] args) {
        ...
        System.out.println("Initial sas size = " + sas.size() + ", length = " + sas.maxSize());
        ...
        System.out.println("Final   sas size = " + sas.size() + ", length = " + sas.maxSize());
