// NOTE: "test vector" is not an array, ArrayList, Vector, or any other collection of objects
// It's a set of data against which to test the class.
// You'll typically write one test for each test vector.
