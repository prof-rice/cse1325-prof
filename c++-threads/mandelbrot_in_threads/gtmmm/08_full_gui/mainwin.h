...
class Mainwin : public Gtk::Window {
  ...
  protected:
    ...
    void on_xoff_value_changed();
    void on_yoff_value_changed();
    void on_icount_value_changed();
    void on_autogen_click();
  ...
  private:
    ...
    Gtk::ToggleToolButton* _autogen_button;
    Gtk::Scale* _scale;
    Gtk::Label* _scale_label;
    Gtk::Scale* _xoff;
    Gtk::Label* _xoff_label;
    Gtk::Scale* _yoff;
    Gtk::Label* _yoff_label;
    Gtk::SpinButton* _icount;
