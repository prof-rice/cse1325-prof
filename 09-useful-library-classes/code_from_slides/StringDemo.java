public class StringDemo {
    public static void main(String[] args) {
        ...
        // To deal with supplemental pages (NOT on the exam), see ExtendedCodePoints.java
        for(char c : sage.toCharArray()) System.out.print(c + '\n');
        
        // Alternately, we can access characters with an index
        for(int i=0; i<sage.length(); ++i) System.out.print(sage.charAt(i) + '\n');
        ...
        // We can copy chars from a String into char[0] from s.charAt(0) to s.length()-1
