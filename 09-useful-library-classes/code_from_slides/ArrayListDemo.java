...
public class ArrayListDemo {
    public static void main(String[] args) {
        ...
        System.out.println("Array size is "     + array.length); // fixed field
        ...
        System.out.println();
        for(int i : ali)   System.out.printf(" %2d", i); // Autoboxing: Integer -> int
        System.out.println();  
        
        if(ali.contains(42)) System.out.println("It's here!");
    }
}
